...
\begin{document}
	...
	\newpage
	\section{Dynamic Model} \input{Dynamic_Model.tex}
	
	
	\newpage
	\section{Equilibria} \input{Equilibria.tex}
	
	
	\newpage
	\section{Stability Analysis} \input{Stability_Analysis.tex}
	
	
	\newpage
	\section{Numerical Computation and Results} \input{Num_Comp.tex}
